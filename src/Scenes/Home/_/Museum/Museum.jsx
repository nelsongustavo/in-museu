    ...
    <div id="museu" className="museum">
			<Grid>
				...
				<Row className="content-section">
					...
					<Col md={3}>
						<p>Sua execução começou em 1808, por ordem do príncipe regente Dom João, logo após sua chegada ao Brasil. Para o trabalho, ele recrutou os melhores gravadores e desenhistas da época.</p>

						<p>Outra valiosa peça é o Prelo Machado de Assis, fabricado em 1833, de origem inglesa. Trata-se de uma máquina de impressão tipográfica para produção de jornais. Uma curiosidade: ela funcionou na Imprensa Nacional até o ano de 1940.</p>
					...
					<Col md={3}>
						...
						<p>Anualmente, essa instituição museológica promove o Concurso Museu da Imprensa de Desenho, Redação, Poesia e Monografia e já está na sua 19ª edição. É uma realização da Imprensa Nacional que atrai estudantes de todo o país.</p>
					</Col>
				</Row>
