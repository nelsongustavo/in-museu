...
const images = [
  {
    ...
    content: 'Exposição da Nau Medusa em miniatura',
		dateTime: '15/05/2018',
		date: '15 MAIO 2018',
		description: 'Embarcação confeccionada para a comemoração dos 500 anos do Brasil e aniversário da Imprensa Nacional (13 de maio) no ano 2000. Nau de linha, de construção em madeira e de propulsão à vela, construída no arsenal de Lisboa com as melhores madeiras do Brasil e lançada ao mar em 29 de agosto de 1786. Media 56m de quilha, 14m de boca e 11m de pontal. Sua artilharia contava com 74 peças lisas, antecargas em baterias corridas. Tinha na proa uma figura da medusa, uma das três górgonas, cuja beleza era extraordinária, aumentada por uma cabeleira magnífica. Partiu incorporada a esquadra que conduziu ao Brasil a família real portuguesa, a 29 de novembro de 1807, sob o comando do capitão-de-mar-e-guerra Henrique da Fonseca de Souza Prego. Em 1819, foi no porto do Rio de Janeiro transformada em Cábrea, e assim se conservou até a Independência. Ainda fazia esse serviço em 1825. Tempo depois foi desarmada no ancoradouro da Saúde. Em 1819, foi no porto do Rio de Janeiro transformada em Cábrea, e assim se conservou até a Independência. Ainda fazia esse serviço em 1825.Tempo depois foi desarmada no ancoradouro da Saúde.'
  },
  {
		id: 2,
    ...
    content: 'Caixa Centenária da Independência',
		dateTime: '15/05/2018',
		date: '15 MAIO 2018',
		description: 'Caixa executada em 1922, na oficina de encadernação da Imprensa Nacional, para figurar na exposição comemorativa do Centenário da Independência do Brasil. Em madeira, couro e papel, com motivos decorativos em dourado. Na tampa, fotografia do prédio da Imprensa Nacional na rua 13 de maio, no Rio de Janeiro. No interior, fotografia de D. Pedro I, com as Armas do Império e de Epitácio Pessoa, com as Armas da República. Entre as duas fotografias, o mapa do Brasil. Dentro, pasta para assinatura dos visitantes à exposição. Fabricante: Setor de encadernação da Imprensa Nacional, Data: 1922, Origem: Rio de Janeiro.'
	},
	{
		id: 3,
    ...
    content: 'Composição Vitrine Florões',
		dateTime: '15/05/2018',
		date: '15 MAIO 2018',
		description: 'Peça com cabo roliço em Madeira, com cabeçote de ferro. Aparelho que serve para conter letras e outros caracteres extraídos um a um dos caixotins, afim de formar palavras ou linhas. Retirado do Setor de acabamento em 1980 para fazer parte do acervo do Museu. São eles: Florão em alusão a D. Pedro I; Florão em alusão a D. Pedro II; Florões de douração manual; Florão de douração manual (moldura).'
	}
];
